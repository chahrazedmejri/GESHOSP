...
<html lang="en">
	<head>
		<title>Patient | modifier votre Profil</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Patient | modifier votre Profil</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Patient </span>
										...
										<div class="col-lg-8 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title">modifier votre Profil</h5>
												</div>
...
<div class="form-group">
					...
					<a href="change-emaild.php">modifier votre email id</a>
														</div>
