	...
	<body class="login">
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<a href="../index.html"><h2>Medical care | Espace Patient</h2></a>
				</div>
				...
				<div class="box-login">
					<form class="form-login" method="post">
						<fieldset>
							<legend>
							Connectez-vous à votre compte							</legend>
							<p>
							...
							Vous n'avez pas encore de compte?								<a href="registration.php">
									Créer un compte
								</a>
							</div>
						</fieldset>
					...
					<div class="copyright">
						&copy; <span class="current-year"></span><span class="text-bold text-uppercase"> Medical care </span>. <span>All rights reserved</span>
					</div>
