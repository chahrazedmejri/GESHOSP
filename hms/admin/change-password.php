...
<html lang="en">
	<head>
		<title>Admin | changer mot de passe </title>
		<meta charset="utf-8" />
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Admin | changer mot de passe</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Admin</span>
						...
						<div class="container-fluid container-fullw bg-white">
							...
							<input type="password" name="cpass" class="form-control"  placeholder="Entrer ancien mot de passe">
														</div>
														<div class="form-group">
...
<div class="form-group">
									...
									<input type="password" name="cfpass" class="form-control"  placeholder="Confirmer mot de passe">
														</div>
