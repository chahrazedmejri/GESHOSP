...
{
?>
											Total utilisateurs :<?php echo htmlentities($num_rows);  } ?>		
												</a>
											</p>
										</div>
									</div>
...
{
?>
											Total médecins :<?php echo htmlentities($num_rows1);  } ?>		
												</a>
								...
								<div class="col-sm-4">
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											...
											<h2 class="StepTitle"> les rendez vous</h2>
...
{
?>
											Total rendez-vous :<?php echo htmlentities($num_rows2);  } ?>	
												</a>
												</a>
											</p>
										</div>
...
?>
											Total Nouvelles requêtes :<?php echo htmlentities($num_rows22);   ?>	
												</a>
												</a>
											</p>
										</div>
