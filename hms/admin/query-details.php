...
if($query){
echo "<script>alert('Remarque de l'administrateur mise à jour avec succès.');</script>";
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Admin | messages</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Admin</span>
						...
						<div class="container-fluid container-fullw bg-white">
									...
									<div class="row">
								<div class="col-md-12">
									<h5 class="over-title margin-bottom-15">Gérer <span class="text-bold">Détails de la requête</span></h5>
...
<tr>
												<th>  Derniér Date de modification</th>
