...
$_SESSION['msg']="Spécialisation de docteur mise à jour avec succès !!";
} 
...
<html lang="en">
	<head>
		<title>Admin | Modifier Spécialisation</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Admin |  Modifier Spécialisation</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Admin</span>
									...
									<li class="active">
										<span> Modifier Spécialisation médcin</span>
									</li>
								</ol>
							</div>
						</section>
										...
										<div class="col-lg-6 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title"> Modifier Spécialisation</h5>
												</div>
...
Modifier Spécialisation	médcin														</label>
