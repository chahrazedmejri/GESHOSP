...
<div class="row">
<div class="col-sm-8">
<h1 class="mainTitle">médecin | modifier Patient</h1>
</div>
<ol class="breadcrumb">
<li>
<span>médecin</span>
...
<h5 class="panel-title">modifier Patient</h5>
</div>
...
<div class="form-group">
              ...
              <input type="radio" name="gender" id="gender" value="male">femme
              <?php } else { ?>
              <label>
              <input type="radio" name="gender" id="gender" value="Male" checked="true">Male
              <input type="radio" name="gender" id="gender" value="Female">homme
              </label>
             <?php } ?>
            </div>
<div class="form-group">
