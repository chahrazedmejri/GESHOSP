...
<html lang="en">
	<head>
		<title>Médecin | Modifier profil</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Médecin | Modifier profil</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Médecin</span>
										...
										<div class="col-lg-8 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title"> Modifier profil</h5>
												</div>
...
<p><b>Date de derniére modification : </b><?php echo htmlentities($data['updationDate']);?></p>
<?php } ?>
<hr />
